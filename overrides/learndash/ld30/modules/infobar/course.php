...
// 2) Calcular si completó todas las lecciones
$prog = learndash_course_progress( array(
    'course_id' => $course_id,
    'user_id'   => $user_id,
    'array'     => true,
) );
...
// 4) Condicional para mostrar burbuja o texto “Awaiting test”
if ( $all_done && empty( $attempts ) ) {
    echo '<span class="ld-awaiting-test">Awaiting test</span>';
} else {
